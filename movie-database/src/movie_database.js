...
const movies_db = [
  ...
  {
    id: 5,
    title: "Dirty Dozen: The Deadly Mission",
  ...
  {
    id: 12,
    title: "How Wang-Fo Was Saved (Comment Wang-Fo fut sauvé)",
  ...
  {
    id: 28,
    title: "Time for Drunken Horses, A (Zamani barayé masti asbha)",
    genre: "Drama",
    year: 1988,
  },
  {
...
const movieSlider = document.getElementById("movie_slider");

function displayMovies(movies) {
  const movie_table = document.getElementById("movie_table");
  movie_table.classList.add("movie-row");

  movie_table.innerHTML = `<tr><th>Title</th><th>Genre</th><th>Year</th></tr>`;
